        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          {loaded && boardMembers.length === 0 ? (
            <div className="p-16 rounded-[12px] bg-[#F8FAFC] border border-[#E2E8F0] text-center space-y-4 max-w-xl mx-auto">
              <Users className="w-12 h-12 text-[#0092DF] mx-auto opacity-60" />
              <h3 className="text-xl font-bold text-[#0092DF]">Board Profiles Coming Soon</h3>
              <p className="text-xs text-[#64748B] leading-relaxed">
                Board member profiles are being updated. Check back shortly!
              </p>
            </div>
          ) : (
