...
const defaultTeamMembers = [
  {
    ...
    bio: 'Oversees strategic direction, institutional partnerships, and high-level advocacy across public health and peacebuilding initiatives in Nigeria.',
    avatar_url: null,
  ...
  {
    id: '2',
    full_name: 'Head of Programmes',
    role_title: 'Head of Operations & Programmes',
    bio: 'Leads overall programme implementation, field monitoring, and community engagement for adolescent health and maternal healthcare projects.',
    avatar_url: null,
    email: 'caph4dev35@gmail.com',
    linkedin_url: '#',
    order_index: 2,
  ...
  {
    id: '3',
    full_name: 'Public Health Lead',
    role_title: 'Adolescent & Child Health Specialist',
    bio: 'Coordinates the NextGeneration Fellowship and Lafiyar Iyali maternal-child healthcare campaigns in rural communities.',
    avatar_url: null,
    email: 'caph4dev35@gmail.com',
    linkedin_url: '#',
    order_index: 3,
  ...
  {
    id: '4',
    full_name: 'Peacebuilding Lead',
    role_title: 'Peacebuilding & Dialogue Officer',
    bio: 'Drives grassroots conflict mediation, youth leadership workshops, and social cohesion dialogues across northern Nigeria.',
    avatar_url: null,
    email: 'caph4dev35@gmail.com',
    linkedin_url: '#',
    order_index: 4,
  ...
  {
    id: '5',
    full_name: 'Civic Accountability Lead',
    role_title: 'Gani da Ido Project Lead',
    bio: 'Manages youth monitors tracking primary healthcare delivery, drug availability, and facility infrastructure at the community level.',
    avatar_url: null,
    email: 'caph4dev35@gmail.com',
    linkedin_url: '#',
    order_index: 5,
  ...
  {
    id: '6',
    full_name: 'Communications Lead',
    role_title: 'Media & Digital Youth Advocate',
    bio: 'Manages e-CAPH publications, press relations, digital advocacy campaigns, and youth engagement platforms.',
    avatar_url: null,
    email: 'caph4dev35@gmail.com',
    linkedin_url: '#',
    order_index: 6,
